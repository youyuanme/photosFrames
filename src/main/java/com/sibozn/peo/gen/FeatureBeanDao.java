...
/** 
 * DAO for table "FEATURE_BEAN".
*/
public class FeatureBeanDao extends AbstractDao<FeatureBean, Long> {

    public static final String TABLENAME = "FEATURE_BEAN";

    /**
     * Properties of entity FeatureBean.<br/>
    ...
    public FeatureBeanDao(DaoConfig config) {
        super(config);
    }
    
    public FeatureBeanDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"FEATURE_BEAN\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"FEATURE_BEAN\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, FeatureBean entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, FeatureBean entity) {
        stmt.clearBindings();
    ...
    @Override
    public FeatureBean readEntity(Cursor cursor, int offset) {
    ...
    @Override
    public void readEntity(Cursor cursor, FeatureBean entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(FeatureBean entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(FeatureBean entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(FeatureBean entity) {
